...
func (s Server) Validate() error {
	...
	if s.OptionsProvider == "massive" && strings.TrimSpace(s.MassiveOptionsAPIKey) == "" {
		return fmt.Errorf("MASSIVE_OPTIONS_API_KEY is required when GO_SERVER_OPTIONS_PROVIDER=massive")
	}
